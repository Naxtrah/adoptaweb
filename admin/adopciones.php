<?php
//Archivo: adopciones.php - Gestión de solicitudes de adopción
...
if (isset($_POST['accion']) && isset($_POST['id_adopcion'])) {
    ...
    if ($accion === 'aprobar') {
        ...
        try {
            ...
            //Verificar si ya existe un pago para esta adopción
    ...
    if ($accion === 'rechazar') {
        ...
        //Liberar animal (volver a disponible)
