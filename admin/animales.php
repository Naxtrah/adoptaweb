<?php
//Archivo: animales.php - Gestión completa de animales
...
<?php else: ?>
<script>
//Scripts para formulario de animal
document.addEventListener('DOMContentLoaded', function() {
    ...
    //Control de selección de vacunas
