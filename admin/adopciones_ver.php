<?php
//Archivo: adopciones_ver.php - Ver detalles de una adopción específica
require_once '../includes/config.php';
//Control de acceso: solo admin logueado
if (!estaLogueado() || !esAdmin()) {
    header('Location: ' . BASE_URL . '/index.php');
    exit();
}

//Obtener ID de adopción desde URL
$id = (int)($_GET['id'] ?? 0);
//Consultar datos completos de la adopción
$stmt = $pdo->prepare("
...
//Redirigir si no existe la adopción
if (!$adopcion) {
        ...
        <div class="col-md-10 p-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!-- Mostrar notas del formulario si existen -->
