...
--
-- Host: mysql
-- Generation Time: Jan 21, 2026 at 12:25 PM
...
--
-- Table structure for table `adopciones_pagos`
--
...
CREATE TABLE `adopciones_pagos` (
  ...
  `token_pago` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `adopciones_pagos`
--
...
CREATE TABLE `animales` (
  ...
  `estado` enum('Disponible','Adoptado','Reservado','En tratamiento') COLLATE utf8mb4_unicode_ci DEFAULT 'Disponible',
...
(1, 'Refugio Patitas Felices', 'Puerta del Sol, 1, 28013 Madrid', '600123456', 'contacto@patitasfelices.org', 'www.patitasfelices.org', '2025-11-02 17:25:55', 40.41688900, -3.70336000, './img/centros/patitasfelices.jpg'),
(2, 'Hogar Animal Madrid', 'Calle de Bravo Murillo, 85, 28003 Madrid', '610987654', 'info@hogaranimal.org', 'www.hogaranimal.org', '2025-11-02 17:25:55', 40.42908000, -3.70156000, './img/centros/hogaranimal.jpg'),
(3, 'Protectora Huellitas', 'Avenida de la Albufera, 285, 28041 Madrid', '620555333', 'huellitas@protectora.org', 'www.huellitas.org', '2025-11-02 17:25:55', 40.38960000, -3.67815000, './img/centros/protectorahuellitas.jpg'),
(4, 'Asociación Paticorazones', 'Calle de Raimundo Fernández Villaverde, 65, 28003 Madrid', '644222998', 'info@paticorazones.org', 'www.paticorazones.org', '2025-11-02 17:25:55', 40.45320000, -3.68826000, './img/centros/asociacionpaticorazones.jpg'),
(5, 'Centro Animalife', 'Calle de la Princesa, 58, 28008 Madrid', '655444888', 'info@animalife.org', 'www.animalife.org', '2025-11-02 17:25:55', 40.43410000, -3.71262000, './img/centros/centroanimalife.jpg');
...
CREATE TABLE `contactos` (
  ...
  `estado` enum('Pendiente','Respondido','Archivado') COLLATE utf8mb4_unicode_ci DEFAULT 'Pendiente',
...
CREATE TABLE `facturas` (
  ...
  `pdf_dirr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `pagos` (
  ...
  `metodo_pago` enum('Tarjeta','PayPal','Transferencia') COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Stand-in structure for view `pagos_detalle_validados`
...
CREATE TABLE `usuarios` (
  ...
  `telefono` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `direccion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tarjeta_last4` char(4) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fecha_registro` datetime DEFAULT CURRENT_TIMESTAMP,
...
--
-- Indexes for table `adopciones_pagos`
--
...
--
-- Indexes for table `pagos_detalle`
--
...
--
ALTER TABLE `adopciones`
  MODIFY `id_adopcion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `adopciones_pagos`
--
ALTER TABLE `adopciones_pagos`
...
--
ALTER TABLE `newsletter`
  MODIFY `id_newsletter` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `pagos`
--
ALTER TABLE `pagos`
  MODIFY `id_pago` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `pagos_detalle`
--
ALTER TABLE `pagos_detalle`
...
--
ALTER TABLE `vacunas`
  MODIFY `id_vacuna` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

-- --------------------------------------------------------

--
-- Structure for view `pagos_detalle_validados`
--
...
--
-- Constraints for table `adopciones_pagos`
--
ALTER TABLE `adopciones_pagos`
...
--
-- Constraints for table `pagos_detalle`
--
ALTER TABLE `pagos_detalle`
