...
<head>
    ...
    <style>
        ...
        .contact-info-box {
            background: linear-gradient(135deg, #5fc376 0%, #218838 100%);
            color: white;
            border-radius: 15px;
            height: 100%;
        }
        
        /*Iconos circulares para información de contacto*/
        .contact-icon {
            width: 50px;
            height: 50px;
                                ...
                                <div class="contact-info-box p-4 shadow">
                                    ...
                                    <div class="text-center mt-4">
                                        ...
                                        <div class="d-flex justify-content-center gap-3 mt-2">
                                            <a target="_blank" href="https://instagram.com" class="text-white fs-4"><i class="fab fa-instagram"></i></a>
                                            <a target="_blank" href="https://twitter.com" class="text-white fs-4"><i class="fab fa-twitter"></i></a>
                                            <a target="_blank" href="https://youtube.com" class="text-white fs-4"><i class="fab fa-youtube"></i></a>
                                            <a target="_blank" href="https://facebook.com" class="text-white fs-4"><i class="fab fa-facebook"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
