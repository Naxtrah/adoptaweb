...
$error = '';
$success = '';
/*Validación de datos del formulario usando la function sanitizar del config.php*/
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($nombre) || empty($email) || empty($asunto) || empty($mensaje)) {
        ...
        /*Try catch para realizar la query y mandar el formulario a la base de datos*/
        try {
            $stmt = $pdo->prepare("
...
<head>
    ...
    <style>
        ...
        .contact-info-box {
            background: linear-gradient(135deg, #75c187 0%, #218838 100%);
            color: white;
            border-radius: 15px;
            height: 100%;
        }
...
<body>
                        ...
                        <div class="contact-info-box p-4 shadow">
                            ...
                            <div class="text-center mt-4">
                                ...
                                <div class="d-flex justify-content-center gap-3 mt-2">
                                    <a target="_blank" href="https://www.instagram.com" class="text-white fs-4"><i class="fab fa-instagram"></i></a>
                                    <a target="_blank" href="https://www.twitter.com" class="text-white fs-4"><i class="fab fa-twitter"></i></a>
                                    <a target="_blank" href="https://www.youtube.com" class="text-white fs-4"><i class="fab fa-youtube"></i></a>
                                    <a target="_blank" href="https://www.facebook.com" class="text-white fs-4"><i class="fab fa-facebook"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!--Validación de datos en el cliente antes de enviar los datos del formulario al servidor-->
    <script>
