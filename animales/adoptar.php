...
//Consultar información del animal y su centro
$stmt = $pdo->prepare("
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !$tiene_solicitud) {
    ...
    if (empty($motivacion)) {
        ...
        try {
            ...
            //Construir notas con toda la información del formulario
...
<body>
    ...
    <div class="container mt-4">
        ...
        <!--Indicador visual de pasos del proceso-->
            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <!--Mensaje si ya existe solicitud-->
                ...
                <!--Información del centro responsable-->
                <div class="card">
            ...
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!--Mostrar formulario solo si no hay éxito ni solicitud previa-->
                        <?php if (!$success && !$tiene_solicitud): ?>
                            ...
                            <form method="POST" action="">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div id="aceptar-soli" class="card-body">
    ...
    <!--Validación JavaScript de términos y condiciones-->
    <script>
