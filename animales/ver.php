...
//Obtener ID del animal desde parámetro GET
$id_animal = isset($_GET['id']) ? (int)$_GET['id'] : 0;

//Consultar información detallada del animal y su centro
$stmt = $pdo->prepare("
...
//Redirigir si el animal no existe
if (!$animal) {
...
//Verificar si el usuario actual tiene solicitud pendiente para este animal
...
//Procesar URL de la imagen del animal
$imagen_animal = '';
...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="animal-header mb-5">
            <div class="row">
                <div class="col-lg-6">
                    <!--Imagen del animal con indicador de estado-->
                        ...
                        <?php if ($animal['estado'] == 'Disponible'): ?>
                            <?php if (estaLogueado()): ?>
                                <?php if ($tiene_solicitud): ?>
                                    <!--Botón deshabilitado si ya tiene solicitud-->
                                    <button class="btn btn-warning btn-lg" disabled>
                                        <i class="fas fa-clock me-2"></i>Solicitud en proceso
                                    </button>
                                <?php else: ?>
                                    <!--Enlace para solicitar adopción-->
                                    <a href="<?= BASE_URL ?>/animales/adoptar.php?id=<?= $animal['id_animal'] ?>" class="btn btn-success btn-lg">
                                        <i class="fas fa-heart me-2"></i>Solicitar adopción
                                    </a>
                                <?php endif; ?>
                            <?php else: ?>
                                <!--Enlace para login si no está autenticado-->
                            ...
                            <?php endif; ?>
                        <?php else: ?>
                            <!--Botón deshabilitado si no está disponible-->
        ...
        <div class="row">
            <div class="col-lg-8">
                <!--Tarjeta con descripción del animal-->
                <div class="card mb-4">
                ...
                <!--Tarjeta de vacunación si hay vacunas-->
            ...
            <!--Información del centro y datos adicionales-->
            <div class="col-lg-4">
                <div class="card mb-4">
        ...
        <!--Sección de animales relacionados del mismo centro-->
        <?php
        ...
        <div class="mt-5">
            ...
            <div class="row g-4">
                <?php while ($relacionado = $relacionados->fetch()): 
                    //Procesar imagen del animal relacionado
                    $imagen_relacionado = '';
