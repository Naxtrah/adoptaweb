...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-01-2026 a las 03:56:28
...
(1, 9, 1, 145.00, 'Pendiente', '2026-01-19 17:59:19', NULL, '2425356ae7572ea7af885c26b21a06977bb63518f9f32d6a75a429c707486bf2'),
...
(25, 'Mimi', 'Gato', 'Siamés', 3, 'Hembra', 'Charlatana y muy apegada a su dueño. No le gusta estar sola mucho tiempo.', '2025-07-15', 'Reservado', 2, './img/animales/mimi.jpg');
...
(6, 'Roberto', 'Díaz', 'roberto.diaz@gmail.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '655555555', 'Calle Primavera 15, Barcelona', NULL, '2025-07-01 10:30:00', 2),
...
--
ALTER TABLE `newsletter`
  MODIFY `id_newsletter` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
