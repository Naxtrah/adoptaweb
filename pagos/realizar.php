...
//Validar que el pago exista y esté pendiente
if (!$pago) {
    $_SESSION['error'] = "Pago no encontrado o ya procesado";
    header('Location: ' . BASE_URL . '/perfil/pagos-pendientes.php');
    exit();
}
//Verificar que el usuario tenga permisos para este pago
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['procesar_pago'])) {
    ...
    if ($valido) {
        // Simulación: 80% de éxito, 20% de fallo
        ...
        if ($exito) {
            try {
                ...
                //Registrar pago en tabla principal de pagos
                ...
                //Registrar detalle del pago (vacunas individuales)
...
//Determinar método de pago actual para mostrar formulario correspondiente
...
<head>
    ...
    <script>
        //Funciones JavaScript para formato de entrada
        ...
        //Mostrar formulario según método de pago seleccionado
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Mostrar formulario del método de pago actual
            showPaymentMethod('<?= $metodo_actual ?>');
            
            //Agregar validadción al enviar formulario
            ...
            //Cambiar formulario al seleccionar otro método de pago
