...
//Obtener token del pago 
$token = $_GET['token'] ?? '';
$error = $_GET['error'] ?? '';

// Mapeo de mensajes de error para diferentes situaciones
$mensajes = [
...
// Seleccionar mensaje apropiado o usar el mensaje por defecto
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="card shadow">
                    <!--Cabecera de la tarjeta con icono de advertencia-->
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="mb-4">
                            <div id="icono_error" class="rounded-circle bg-danger d-inline-flex align-items-center justify-content-center mb-3"
