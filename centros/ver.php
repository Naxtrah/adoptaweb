...
//Consultar información detallada del centro
$stmt = $pdo->prepare("
    SELECT c.*, 
...
//Redirigir si el centro no existe
if (!$centro) {
    header('Location: ' . BASE_URL . '/centros');
    exit();
}

//Consultar animales más recientes
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <!--Botón para ver animales del centro-->
                    ...
                    <div class="col-md-4 text-center">
                        ...
                        <?php if (!empty($centro['imagen_url'])): ?>
                            <div class="mb-3">
                                <img id="img-center" src="../<?= ltrim($centro['imagen_url'], './') ?>" alt="<?= htmlspecialchars($centro['nombre']) ?>" class="img-fluid rounded">
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-8">
                ...
                <!--Tarjeta con animales del centro-->
