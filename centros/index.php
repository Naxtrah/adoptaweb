...
//Consultar centros con conteo de animales
$stmt = $pdo->prepare("
    SELECT c.*, 
...
<body>
    ...
    <div class="container mt-4">
        ...
        <!--Lista de tarjetas de centros-->
        <div class="row g-4">
            <?php foreach ($centros as $centro): ?>
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 shadow-sm">
                        <!--Imagen del centro con indicador de disponibilidad-->
                        ...
                        <div class="card-body">
                            ...
                            <!--Pie de tarjeta con contador y enlace-->
