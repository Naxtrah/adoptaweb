...
<head>
    ...
    <style>
        .faq-header {
            background: linear-gradient(135deg, #28883e 0%, #47a45b 100%);
            color: white;
            padding: 60px 0;
            margin-bottom: 40px;
        }
        ...
        .contact-cta {
            background: linear-gradient(135deg, #ecedef 0%, #eaedf0 10%);
            border-radius: 15px;
            padding: 40px;
            margin-top: 40px;
        }
...
<body>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (searchInput) {
            searchInput.addEventListener('input', function() {
                ...
                if (searchTerm.length < 2) {
                    // Mostrar todos si la búsqueda es muy corta
                ...
                accordionButtons.forEach(btn => {
                    ...
                    if (questionText.includes(searchTerm)) {
                        ...
                        //Expandir la pregunta encontrada
        ...
        questionCountElement.innerHTML = `<i class="fas fa-info-circle me-1"></i> Mostrando las ${totalQuestions} preguntas más frecuentes`;
...
<body>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Enlaces suaves para navegación
        document.querySelectorAll('a[href^="#"]').forEach(anchor => {
            anchor.addEventListener('click', function (e) {
                e.preventDefault();
                const targetId = this.getAttribute('href');
