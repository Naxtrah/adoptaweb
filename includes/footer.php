    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-md-6 mb-4 text-center">
                ...
                <form id="newsletter-form" class="mx-auto" style="max-width: 300px;">
                    ...
                    <div id="newsletter-message" class="small"></div>
                </form>
                <div class="mt-3">
            ...
            <div class="col-md-4 mb-4 mb-md-0 text-center">
                ...
                <div class="d-flex justify-content-center gap-3">
                    <a href="<?= BASE_URL ?>/contacto.php" class="btn btn-outline-light btn-sm">
                ...
                <div class="mt-4 text-center">
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        <a target="_blank" href="https://instagram.com" class="text-white fs-5" title="Instagram">
                            <i class="fab fa-instagram"></i>
                        </a>
                        <a target="_blank" href="https://twitter.com" class="text-white fs-5" title="Twitter">
                            <i class="fab fa-twitter"></i>
                        </a>
                        <a target="_blank" href="https://youtube.com" class="text-white fs-5" title="YouTube">
                            <i class="fab fa-youtube"></i>
                        </a>
                        <a target="_blank" href="https://facebook.com" class="text-white fs-5" title="Facebook">
        ...
        <div class="text-center pt-4 mt-4 border-top border-white-50">
            <a class="navbar-brand mb-2" href="<?= BASE_URL ?>/">
                <i class="fas fa-paw me-2"></i>AdoptaWeb
            </a>
            <p class="text-white-50 small mb-0 mt-2">
                &copy; 2026 AdoptaWeb. Todos los derechos reservados.
            </p>
        </div>
    </div>
</footer>
<!--Manejo de las cookies con php-->
...
//Manejar cuando el usuario rechace las cookies
...
//Pequeña function para validad los gmails
