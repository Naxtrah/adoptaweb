            ...
            <div class="col-lg-10">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body p-4 terms-container">
                        ...
                        <ul>
                            <li>Proporcionar todos los cuidados necesarios al animal (alimentación, veterinario...).</li>
                        ...
                        <p>Estos términos se rigen por la legislación española. Cualquier disputa será resuelta en los tribunales de la Comunidad de Madrid.</p>   
                        <div class="highlight-box">
                        ...
                        <!--Aceptación de términos y condiciones para el usuario con un botón para imprimir dicho documento-->
                    ...
                    <div class="col-md-4">
                        <div class="card h-100">
                            <div class="card-body text-center">
                                ...
                                <a href="includes/faq.php" class="btn btn-outline-success btn-sm">Ver FAQ</a>
                            </div>
                        </div>
                    </div>
                </div>
