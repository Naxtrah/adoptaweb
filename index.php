...
<body>
    ...
    <!--Sección encuentra a tu mejor amigo-->
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="lead mb-4">
                        AdoptaWeb conecta animales rescatados con personas que buscan darles un hogar. 
                        Trabajamos con múltiples centros para salvar tantas vidas como sea posible.
                    </p>
                    <div class="d-flex flex-wrap gap-3">
                        <a href="<?= BASE_URL ?>/centros" class="btn btn-light btn-hero">
    ...
    <!--Estadísticas generales de la web-->
    <section class="container mb-5">
        <div class="row g-4">
            <?php
            //Sacamos estadisticas de la web con queries muy sencillas
            $stats = [
    ...
    <section class="container mb-5">
        ...
        <div class="row g-4">
            <?php
            //Query para sacar datos de cada animal de nuestra database
            $animales = $pdo->query("
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="text-center p-4">
                        ...
                        <h4>1. Busca</h4>
                        <p class="text-muted">
                            Explora nuestro listado de animales disponibles. 
                            Usa filtros para encontrar a tu compañero ideal.
                        </p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="text-center p-4">
                        ...
                        <p class="text-muted">
                            ...
                            El centro contactará contigo para una entrevista.
                        </p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="text-center p-4">
                        ...
                        <h4>3. Adopta</h4>
                        <p class="text-muted">
                            Conoce a tu nuevo amigo en el centro y llévatelo a casa. 
                            Te ayudaremos con el proceso de adaptación.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <!-- Testimonios de clientes que hemos tenido-->
    <section class="container mb-5">
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card p-4">
                    ...
                    <p class="text-muted">
                        "Adoptar a Luna fue la mejor decisión. El proceso fue sencillo y 
                        el centro nos ayudó en todo momento. ¡Gracias AdoptaWeb!"
                    </p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card p-4">
                    ...
                    <p class="text-muted">
                        "Max llegó a nuestra familia hace 6 meses y ha cambiado nuestras vidas. 
                        La plataforma hizo muy fácil encontrar al perro perfecto para nosotros."
                    </p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card p-4">
                    ...
                    <p class="text-muted">
                        "Misu es la gata más cariñosa del mundo. El seguimiento post-adopción 
                        fue excelente. Recomiendo AdoptaWeb a todo el mundo."
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="card bg-success text-white border-0">
            <div class="row g-0 align-items-center">
                <div class="col-md-8 p-5">
                    ...
                    <p class="mb-4">
                        Miles de animales esperan un hogar. Tú puedes ser su segunda oportunidad.
                    </p>
                ...
                <div  class="col-md-4" >
                    <img src="<?= ASSETS_URL ?>indexMainperro2.jpg" 
                         alt="Perro feliz" 
                         class="img-fluid rounded-1 pe-3">
                </div>
            </div>
        </div>
    </section>
