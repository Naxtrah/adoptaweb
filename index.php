...
<head>
    ...
    <style>
        ...
        /*Tarjetas de animales con animación*/
        .animal-card {
            border-radius: 15px;
            overflow: hidden;
            transition: all 0.3s;
        ...
        /*Contenedores para iconos circulares*/
        #div_adopcion, #div_adopcion2, #div_adopcion3 {
            width: 80px;
            height: 80px;
        }
        #user1, #user2, #user3 {
...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="lead mb-4">AdoptaWeb conecta animales rescatados con personas que buscan darles un hogar.</p>
    ...
    <section class="container mb-5">
        <div class="row g-4">
            <?php
            // Consultar estadísticas para mostrar en tarjetas
            $stats = [
    ...
    <section class="container mb-5">
        ...
        <div class="row g-4">
            <?php
            //Consultar últimos 4 animales disponibles
            $animales = $pdo->query("
            ...
            foreach ($animales as $animal):
                //Procesar URL de imagen del animal
                $imagen_animal = '';
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="card animal-card h-100">
                    ...
                    <div class="card-footer bg-white border-top-0">
                        <!--Botón para ver detalles del animal-->
    ...
    <!--Explicación proceso de adopción-->
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="text-center p-4">
                        <div id="div_adopcion" class="rounded-circle bg-success d-inline-flex align-items-center justify-content-center mb-3">
                ...
                <div class="col-md-4">
                    <div class="text-center p-4">
                        <div id="div_adopcion2" class="rounded-circle bg-success d-inline-flex align-items-center justify-content-center mb-3">
                ...
                <div class="col-md-4">
                    <div class="text-center p-4">
                        <div id="div_adopcion3" class="rounded-circle bg-success d-inline-flex align-items-center justify-content-center mb-3">
    ...
    <!--Testimonios-->
    <section class="container mb-5">
        <h2 class="text-center mb-5 fw-bold">Reseñas de nuestros últimos clientes</h2>
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card p-4">
                    <div class="d-flex align-items-center mb-3">
                        <div id="user1" class="rounded-circle bg-success d-flex align-items-center justify-content-center me-3">
                    ...
                    <p class="text-muted">"Adoptar a Luna fue la mejor decisión. El proceso fue sencillo y el centro nos ayudó en todo momento."</p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card p-4">
                    <div class="d-flex align-items-center mb-3">
                        <div id="user2" class="rounded-circle bg-success d-flex align-items-center justify-content-center me-3">
                            <i class="fas fa-user text-white fa-lg"></i>
                        </div>
                        <div>
            ...
            <div class="col-md-4">
                <div class="card p-4">
                    <div class="d-flex align-items-center mb-3">
                        <div id="user3" class="rounded-circle bg-success d-flex align-items-center justify-content-center me-3">
                            <i class="fas fa-user text-white fa-lg"></i>
                        </div>
                        <div>
