<?php
//Determinar la página actual para resaltar el enlace correspondiente
...
<div class="card mb-4">
    ...
    <div class="list-group list-group-flush">
        ...
        <!--Pagos pendientes con contador dinámico-->
        <a href="<?= BASE_URL ?>/perfil/pagos-pendientes.php" 
           class="list-group-item list-group-item-action <?= $pagina_actual == 'pagos-pendientes.php' ? 'active' : '' ?>">
            ...
            <?php 
            if (estaLogueado()) {
                //Consultar número de pagos pendientes
                ...
                //Mostrar badge rojo si hay pagos pendientes
                if ($num_pendientes > 0): ?>
